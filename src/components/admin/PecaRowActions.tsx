...
export function PecaRowActions({ id, name, isAvulsa }: { id: string; name: string; isAvulsa?: boolean }) {
  ...
  const editHref = isAvulsa ? `/admin/financeiro/pecas-avulsas/${id}/editar` : `/admin/pecas/${id}/editar`

  return (
    <div className="flex items-center gap-1 flex-shrink-0">
      <Link href={editHref} className="p-1.5 text-brand-muted hover:text-brand-mauve transition-colors">
